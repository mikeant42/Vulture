...
public class HabitablePlanet extends Planet {
    ...
    private Vector3f atmosphereColor = new Vector3f(0.7f, 0.2f, 0.6f);
    private String name;
    ...
    public void generate(String colorMap, Function2D function) {
        this.shader = new RawShader("default.vert", "planet/planet.frag", colorMap);
    ...
    @Override
    public void update() {
        this.getTransform().setRotation(new Vector2f(this.getTransform().getRotation().x + 0.01f, this.getTransform().getRotation().y));
    }
